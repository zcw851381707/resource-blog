          ...
          {page === 'login' && (
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative"><input type={showPwd.has("login") ? "text" : "password"} className={inputClass + ' pr-10'} placeholder="请输入密码" value={loginPass} onChange={e => setLoginPass(e.target.value)} onKeyDown={detectCaps("login")} onKeyUp={detectCaps("login")} /><button type="button" onClick={() => togglePwd("login")} className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center text-[var(--text-muted)] hover:text-[var(--text-secondary)]"><svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path d="M12 5C7 5 2.73 8.11 1 12c1.73 3.89 6 7 11 7s9.27-3.11 11-7c-1.73-3.89-6-7-11-7z"/><circle cx="12" cy="12" r="3"/></svg></button></div>
          ...
          {page === 'register' && (
            <form onSubmit={handleRegister} className="space-y-3">
              ...
              <div>
                ...
                <div className="relative"><input type={showPwd.has("reg") ? "text" : "password"} className={inputClass + ' pr-10'} placeholder="至少 6 位，区分大小写+数字" value={regPass} onChange={e => setRegPass(e.target.value)} onKeyDown={detectCaps("reg")} onKeyUp={detectCaps("reg")} /><button type="button" onClick={() => togglePwd("reg")} className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center text-[var(--text-muted)] hover:text-[var(--text-secondary)]"><svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path d="M12 5C7 5 2.73 8.11 1 12c1.73 3.89 6 7 11 7s9.27-3.11 11-7c-1.73-3.89-6-7-11-7z"/><circle cx="12" cy="12" r="3"/></svg></button></div>
              ...
              <div>
                ...
                <div className="relative"><input type={showPwd.has("reg2") ? "text" : "password"} className={inputClass + ' pr-10'} placeholder="请再次输入密码" value={regPass2} onChange={e => setRegPass2(e.target.value)} onKeyDown={detectCaps("reg2")} onKeyUp={detectCaps("reg2")} /><button type="button" onClick={() => togglePwd("reg2")} className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center text-[var(--text-muted)] hover:text-[var(--text-secondary)]"><svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path d="M12 5C7 5 2.73 8.11 1 12c1.73 3.89 6 7 11 7s9.27-3.11 11-7c-1.73-3.89-6-7-11-7z"/><circle cx="12" cy="12" r="3"/></svg></button></div>
          ...
          {page === 'forgot' && (
            <form onSubmit={handleReset} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative"><input type={showPwd.has("fp") ? "text" : "password"} className={inputClass + ' pr-10'} placeholder="至少 6 位，区分大小写+数字" value={fpPass} onChange={e => setFpPass(e.target.value)} onKeyDown={detectCaps("fp")} onKeyUp={detectCaps("fp")} /><button type="button" onClick={() => togglePwd("fp")} className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center text-[var(--text-muted)] hover:text-[var(--text-secondary)]"><svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path d="M12 5C7 5 2.73 8.11 1 12c1.73 3.89 6 7 11 7s9.27-3.11 11-7c-1.73-3.89-6-7-11-7z"/><circle cx="12" cy="12" r="3"/></svg></button></div>
              ...
              <div>
                ...
                <div className="relative"><input type={showPwd.has("fp2") ? "text" : "password"} className={inputClass + ' pr-10'} placeholder="请再次输入新密码" value={fpPass2} onChange={e => setFpPass2(e.target.value)} onKeyDown={detectCaps("fp2")} onKeyUp={detectCaps("fp2")} /><button type="button" onClick={() => togglePwd("fp2")} className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center text-[var(--text-muted)] hover:text-[var(--text-secondary)]"><svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24"><path d="M12 5C7 5 2.73 8.11 1 2.73 3.89 6 7 11 7s9.27-3.11 11-7c-1.73-3.89-6-7-11-7z"/><circle cx="12" cy="12" r="3"/></svg></button></div>
