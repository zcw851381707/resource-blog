...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const { title, subtitle, highlightWord, image, mediaType, videoUrl, videoPoster, videoDuration, gradientFrom, gradientTo, buttonText, buttonLink, bannerLink, showButton, isPortrait, portraitImages, isAd, adLabel, sortOrder, isActive, dramaId, description, imagePosition } = body
